...
export async function POST(req: NextRequest) {
  ...
  // Fail closed. With no VAI_MESSAGE_HOUSE_PASSWORD configured there is no
  // passphrase to match, so no request can unlock the deck.
  ...
  res.cookies.set(VAI_MESSAGE_HOUSE_COOKIE, token, {
    httpOnly: true,
    secure: true,
    sameSite: "lax",
    path: VAI_MESSAGE_HOUSE_PATH,
