...
Through restricting access to a money system, a container for economic value flow can be created. By creating some boundary — between what is "internal" / "external", or "local" / "foreign" — economic agents that belong to the community and those that don't — pockets of flourishing can emerge. ...(defer to experts to describe how this flourishing manifests based on evidence).
...
The first requirement is a common necessity for any system of money: belief. An economic agent — a person, business or other account holder — must be willing to accept payment in a particular currency for it to have value. Every system of money rests on this foundation of consent — though very often people face a Hobson's choice, or rather, there is no choice of which money to use at all. (More on how to create beliefs within a market that a particular currency is valuable / acceptable as a medium for transaction)
