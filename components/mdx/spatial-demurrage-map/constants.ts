...
export const DEFAULT_DECAY_FUNCTION: DecayFunction = {
  type: 'exponential',
  lambda: 3,
};

/** Zone fill color */
export const ZONE_COLOR = '#10b981'; // emerald-500

/** Buffer ring base color */
export const BUFFER_COLOR = '#3b82f6'; // blue-500

/**
 * Islington borough boundary (simplified for performance)
 * Source: https://www.planning.data.gov.uk/entity/8600302
 */
export const ISLINGTON_ZONE: Feature<MultiPolygon> = {
  type: 'Feature',
